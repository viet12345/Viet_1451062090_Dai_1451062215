...
<div class="clear"></div>
	...
	?>
        ...
        <li>       
             <a href="index.php?p=chitiettin&idTin=<?php echo $row_tincungloai['idTin'] ?>"><img src="upload/tintuc/<?php echo $row_tincungloai['urlHinh'] ?>" alt="<?php echo $row_tincungloai['TieuDe_KhongDau'] ?>"></a> <br />
